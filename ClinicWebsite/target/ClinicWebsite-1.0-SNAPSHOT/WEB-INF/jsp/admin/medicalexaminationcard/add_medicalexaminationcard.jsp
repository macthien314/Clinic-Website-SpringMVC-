<%-- 
    Document   : add_medicalexaminationcard
    Created on : 17 Mar 2023, 15:57:28
    Author     : thien
--%>
...
<h2 class="mt-4">Thêm phiếu khám</h2>
...
<div class="card">
    ...
    <article class="card-body">
        ...
        <form:form id="medicalexaminationcard" action="${action}" modelAttribute="medicalexaminationcard" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block">Tạo Phiếu Khám</button>
            </div>
