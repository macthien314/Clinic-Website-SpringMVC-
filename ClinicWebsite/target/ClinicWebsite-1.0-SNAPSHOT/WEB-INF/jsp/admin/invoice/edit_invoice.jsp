<%-- 
    ...
    Created on : 17 Mar 2023, 15:54:14
    Author     : thien
--%>
...
<c:url value="/admin/invoice-manager/edit-invoice" var="action"/>
<h2 class="mt-4">Chỉnh Sửa Hóa Đơn </h2>
    ...
    <article class="card-body">
        ...
        <form:form id="invoice" action="${action}" modelAttribute="invoice" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block">Chỉnh Sửa Hóa Đơn</button>
            </div>
