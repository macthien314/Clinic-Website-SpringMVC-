<%-- 
    Document   : dashboard
    Created on : 17 Mar 2023, 15:44:58
    Author     : thien
--%>
    ...
    <div class="col-xl-6">
        <div class="card mb-4">
            <div class="card-header">
                ...
                Bệnh nhân đến khám theo tháng(2021) <a class="btn btn-success ml-1" href="<c:url value="/admin/numpatient-month"/>">Chi tiết</a>
            </div>
    ...
    <div class="col-xl-6">
        <div class="card mb-4">
            <div class="card-header">
                ...
                Danh thu theo tháng(2021)<a class="btn btn-success ml-2" href="<c:url value="/admin/revenuestats-month"/>">Chi tiết</a>
            </div>
