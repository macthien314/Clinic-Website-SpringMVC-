<%-- 
    ...
    Created on : 17 Mar 2023, 16:14:34
    Author     : thien
--%>
            ...
            <c:forEach items="${slides}" var="s">
                <tr>
                    ...
                    <td class="setting d-flex justify-content-between align-items-center gap-2 w-100 border-0">
                        ...
                        <a class="p-2" data-toggle="tooltip" title="chỉnh sửa" href="<c:url value="/admin/quanly-slide/sua-slide/${s.id}"/>">
                            <i class="fas fa-edit" style="color:#6633ff"></i>
                        </a>

                        <a class="p-2" id="modal" href="<c:url value="/admin/quanly-slide/xoa-slide/${s.id}"/>" name="deleteButton" type="button" class="" data-toggle="tooltip modal" data-target="#deleteModal" title="Xóa sản phẩm">
