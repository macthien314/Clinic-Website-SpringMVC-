<%-- 
    Document   : add_prescriptiondrug
    Created on : 17 Mar 2023, 16:07:29
    Author     : thien
--%>
...
<c:url value="/admin/prescriptiondrug-manager/add-prescriptiondrug" var="action"/>
<h2 class="mt-4">Thêm chi tiết toa thuốc </h2>
    ...
    <article class="card-body">
        ...
        <form:form id="drug" action="${action}" modelAttribute="prescriptiondrug" method="post" enctype="multipart/form-data">
            ...
            <div class=" form-row">
                ...
                <div class=" form-group col-md-6">
                    <label for="prescription">Mã toa thuốc ></label>
