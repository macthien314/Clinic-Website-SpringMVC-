<%-- 
    Document   : prescription_manager
    Created on : 17 Mar 2023, 16:05:45
    Author     : thien
--%>
            ...
            <c:forEach items="${prescriptions}" var="s">
                <tr>
                    ...
                    <td class="setting d-flex justify-content-between align-items-center gap-2 w-100 border-0">
                        ...
                        <a class="p-1" data-toggle="tooltip" title="xem thông tin" title="thông tin"href="<c:url value="/admin/quanly-slide/chitiet-slide/${s.id}"/>"> <i class="fas fa-info-circle" style="color:#18d26e"></i></a>
                        <a class="p-1" data-toggle="tooltip" title="chỉnh sửa" href="<c:url value="/admin/prescription-manager/edit-prescription/${s.id}"/>">
                            <i class="fas fa-edit" style="color:#6633ff"></i>
                        </a>

                        <a class="p-1" id="modal" href="<c:url value="/admin/prescription-manager/delete-prescription/${s.id}"/>" name="deleteButton" type="button" class="btn btn-primary" data-toggle="tooltip modal" data-target="#deleteModal" title="Xóa toa thuốc">
