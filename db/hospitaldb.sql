...
--
-- Host: localhost    Database: cilinc
-- ------------------------------------------------------
...
INSERT INTO `doctor` VALUES (1,'Nguyễn','Phương Dung','2000-12-31','Nữ','0989054761','NPDDung@gmail.com','hơn 5 năm','https://res.cloudinary.com/ikj/image/upload/v1634963674/nguyen-phuong-dung_lcv4mo.jpg',1,9,NULL),(2,'Nguyễn','Thị Doan','1990-02-28','Nữ','01684346876','NTDDoan@gmail.com','hơn 20 năm','https://res.cloudinary.com/ikj/image/upload/v1634963870/nguyen-thi-doan_kzdtzt.jpg',1,4,NULL),(3,'Võ','Văn Anh','2000-12-31','Nam','0989054794','VVAAnh@gmail.com','hơn 15 năm','https://res.cloudinary.com/ikj/image/upload/v1634961259/vo-van-anh_brx3pj.jpg',1,5,NULL),(4,'Nguyễn','Trâm Anh','2000-12-31','Nữ','0989054100','NTATTram@gmail.com','hơn 5 năm','https://res.cloudinary.com/ikj/image/upload/v1634964426/nguyen-thi-ai-tram_z0i5ki.jpg',1,6,NULL);
...
CREATE TABLE `medical` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='tổ chức y khoa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `medical_examination_card` (
  ...
  `sympton` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `diagnosis` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `patient_id` int DEFAULT NULL,
  `nurse_id` int DEFAULT NULL,
  `doctor_id` int DEFAULT NULL,
...
INSERT INTO `nurse` VALUES (1,'Lê','Thị Thanh','2000-03-16','Nữ','0989076898','Thanh@gmail.com','https://res.cloudinary.com/ikj/image/upload/v1637045285/9_mibbl7.jpg',1,3,NULL),(2,'Lý','Nhã Hân','2000-02-16','Nữ','0989076844','Han@gmail.com','https://res.cloudinary.com/ikj/image/upload/v1637045285/9_mibbl7.jpg',1,7,NULL),(3,'Lê','Tuệ Như','1998-02-16','Nữ','0989076844','Nhu@gmail.com','https://res.cloudinary.com/ikj/image/upload/v1637045285/9_mibbl7.jpg',1,8,NULL),(4,'yoo jung','kim ','2001-02-16','Nữ','0987654','1@gmail.com','https://res.cloudinary.com/ikj/image/upload/v1640425410/nurse/btsoin3ehcixsxytfntl.jpg',1,10,NULL);
...
INSERT INTO `patient` VALUES (1,'Lê','Thị Vy','2000-12-31','Nữ','098765433','59481@gmail.com','https://res.cloudinary.com/ikj/image/upload/v1637045613/12_exbseu.jpg',NULL,'Gò vấp, HCM'),(2,'Lê','Anh','2000-12-31','Nam','098765433','132@gmail.com','https://res.cloudinary.com/ikj/image/upload/v1637045613/12_exbseu.jpg',NULL,'tân bình'),(3,'Ly','Lee','2000-12-12','Nam','0987654','1@gmail.com','https://res.cloudinary.com/ikj/image/upload/v1637045613/12_exbseu.jpg',NULL,NULL),(4,'mơ','nguyễn','2000-12-31','Nam','333','333','https://res.cloudinary.com/ikj/image/upload/v1637045613/12_exbseu.jpg',NULL,'bà rịa vũng tàu'),(5,'Lê','Thị Hòa Binh','2000-12-31','Nữ','05839582048','jhk@gmail.com','https://res.cloudinary.com/ikj/image/upload/v1637045613/12_exbseu.jpg',NULL,'TP Hòa Bình'),(6,'Trần','Hồng Thấm','2000-12-31','Nữ','123555','jhk@gmail.com','https://res.cloudinary.com/ikj/image/upload/v1637029278/patient/mgktusvshuubmsntz5rj.jpg',NULL,'tân bình');
...
INSERT INTO `prescription_drug` VALUES (1,'sáng 1 viên chiều 1 viên',1,4,1),(2,'sáng 1 viên chiều 1 viên',30,5,4),(3,'sáng 1 viên',15,5,2),(4,'Uống 1 sáng 1 chiều',20,6,4),(5,'1 sáng 1 chiều',20,6,5);
...
INSERT INTO `services` VALUES (1,'Đo điện tim(Ecg)',100000,'https://res.cloudinary.com/ikj/image/upload/v1636719495/service/sraix48ca54cv4t9gvzw.jpg'),(2,'Khám sức khỏe tổng quát',90000,'https://res.cloudinary.com/ikj/image/upload/v1637068533/1_ydmg48.png'),(3,'Xét nghiệm máu',200000,'https://res.cloudinary.com/ikj/image/upload/v1637068533/1_ydmg48.png'),(4,'Chụp x quang kỹ thuật số',200000,'https://res.cloudinary.com/ikj/image/upload/v1637068533/1_ydmg48.png'),(5,'Răng hàm mặt',200000,'https://res.cloudinary.com/ikj/image/upload/v1637068533/1_ydmg48.png'),(6,'Nội soi tai mũi họng',200000,'https://res.cloudinary.com/ikj/image/upload/v1637068533/1_ydmg48.png');
...
INSERT INTO `user` VALUES (1,'admin12345','$2a$10$m9UGDIjt4jU1sxQA599dNeqoj.z.ZijlhkrBblYRy/AndbsqcdrwK','433333','Lê điền tài','0kg@gmail.com','ROLE_ADMIN','123555',NULL,'https://res.cloudinary.com/ikj/image/upload/v1633071771/Doctor/ttsqktplgif3udby8kcz.png'),(2,'1doctorphuongdung','123','123','123','123','ROLE_DOCTOR','123',_binary '','https://res.cloudinary.com/ikj/image/upload/v1634963674/nguyen-phuong-dung_lcv4mo.jpg'),(3,'1nurseleff','$2a$10$4qP/ywFPozmP5Doizl7MXOfjMlBKfJMRk5ClFV3s09xfxLMPcvZny','Lê','ff','ss@gmail.com','ROLE_NURSE','123555',NULL,'https://res.cloudinary.com/ikj/image/upload/v1634561416/nurse/znfsjellubqebnedepue.png'),(4,'2doctorthidoannguyen','$2a$10$VF8mkx08De8pyB1XDt6jfecPpqt6kufJDzw/CJmp/PlbOLSOTK/C6','Thị Doan','Nguyễn','NTDDoan@gmail.com','ROLE_DOCTOR','01684346876',NULL,'https://res.cloudinary.com/ikj/image/upload/v1634963870/nguyen-thi-doan_kzdtzt.jpg'),(5,'3doctorvananhvo','$2a$10$o6y22xSDDNQtGuX/Ox7Atej5q2T25Jaczns8OE3ci40xG3q.YWst2','Văn Anh','Võ','VVAAnh@gmail.com','ROLE_DOCTOR','0989054794',NULL,'https://res.cloudinary.com/ikj/image/upload/v1634961259/vo-van-anh_brx3pj.jpg'),(6,'4doctorthiaitramnguyen','$2a$10$zkQ.iF3CZRHY6kcwrAl5Ye1nMlNSwUumHtinRs4zCRdcxZdD296Xe','Thị Ái Trâm','Nguyễn','NTATTram@gmail.com','ROLE_DOCTOR','0989054100',NULL,'https://res.cloudinary.com/ikj/image/upload/v1634964426/nguyen-thi-ai-tram_z0i5ki.jpg'),(7,'3nurselethi','$2a$10$TBnQFxQVkHXVu8hfNvUINuicS8MyFxkOieWHGiTkACNhms5xq5XMq','Lê','thị','ss@gmail.com','ROLE_NURSE','333',NULL,'https://res.cloudinary.com/ikj/image/upload/v1636197790/nurse/gfvz6eexk5whidxmx7ye.png'),(8,'3nurselethi3','$2a$10$TBnQFxQVkHXVu8hfNvUINuicS8MyFxkOieWHGiTkACNhms5xq5XMq','Lê','thị','ss@gmail.com','ROLE_NURSE','3333',_binary '','https://res.cloudinary.com/ikj/image/upload/v1636197790/nurse/gfvz6eexk5whidxmx7ye.png'),(9,'1doctorphuongdungnguyen','$2a$10$dMW5kP7oLyR0CMqRY.PGb.ELo0egmPFcVvDUdrjjXXvQYy4u1ek.O','Phương Dung','Nguyễn','NPDDung@gmail.com','ROLE_DOCTOR','0989054761',NULL,'https://res.cloudinary.com/ikj/image/upload/v1634963674/nguyen-phuong-dung_lcv4mo.jpg'),(10,'4nursekimyoojung','$2a$10$RWNPTvJrsONU93V48kkeAuB/b08UQwUbddrd6xgv7JOe9jyriQhVy','kim ','yoo jung','1@gmail.com','ROLE_NURSE','0987654',NULL,'https://res.cloudinary.com/ikj/image/upload/v1640425410/nurse/btsoin3ehcixsxytfntl.jpg');
...
-- Dump completed on 2023-04-12 13:51:14
